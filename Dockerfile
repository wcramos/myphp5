...
LABEL Description="php5.6 and Apache2.4 stack, based on Debian." \
	...
	Usage="docker run -d -p [HOST WWW PORT NUMBER]:8080 -p [HTTPS WWW PORT]:8443 -v [HOST WWW DOCUMENT ROOT]:/var/www/html -v [HOST WWW LOG DIR]:/var/log/apache2 -v [APACHE CONFIG DIR]:/etc/apache2 wcramos/myphp5" \
	Version="1.0"
